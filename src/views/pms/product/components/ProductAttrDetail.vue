    ...
    <el-form :model="value" ref="productAttrForm" label-width="120px" style="width: 720px" size="small">
      ...
      <el-form-item label="商品规格：">
        <el-card shadow="never" class="cardBg">
          <div :key="idx" v-for="(productAttr,idx) in selectProductAttr">
            {{productAttr.name}}：
            ...
            <div v-else>
              <el-checkbox-group v-model="selectProductAttr[idx].values">
                <div :key="index" v-for="(item,index) in selectProductAttr[idx].options" style="display: inline-block"
      ...
      <el-form-item label="属性图片：" v-if="hasAttrPic">
        <el-card shadow="never" class="cardBg">
          <div :key="index" v-for="(item,index) in selectProductAttrPics">
            <span>{{item.name}}:</span>
      ...
      <el-form-item label="商品参数：">
        <el-card shadow="never" class="cardBg">
          <div :key="item" v-for="(item,index) in selectProductParam" :class="{littleMarginTop:index!==0}">
